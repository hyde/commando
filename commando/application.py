...
from .util import getLoggerWithConsoleHandler
    ...
    def __new__(mcs, name, bases, attrs):
        ...
        def add_subparser(func):
            ...
            if not func.parent:
                ...
                if not getattr(parent, 'parser', None):
                    # Parser doesn't exist for the parent.
                    add_subparser(parent)
                if not getattr(parent, 'subparsers', None):
...
class version(param):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, action='version', **kwargs)
...
class true(param):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, action='store_true', **kwargs)
...
class false(param):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, action='store_false', **kwargs)
...
class const(param):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, action='store_const', **kwargs)
...
class append(param):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, action='append', **kwargs)
...
class append_const(param):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, action='append_const', **kwargs)


class Application(object, metaclass=Commando):
    """
